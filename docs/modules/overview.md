...
| [Data Security](/falcon-mcp/modules/data-security/) | `Data Protection:read`, `Data Protection:write` | Provides access to Data Security configuration data — classifications, policies, content patterns, cloud/local applications, enterprise accounts, web locations, sensitivity labels, and file types — so an LLM can inspect, create, and update Data Security rule definitions |
...
| [Guardian](/falcon-mcp/modules/guardian/) | `AIDR:read` | Provides tools for querying AI agent inventory and activity data |
